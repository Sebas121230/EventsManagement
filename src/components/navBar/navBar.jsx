    ...
    return (
        <Navbar fluid rounded className={styles.navbar}>
            <div className="w-full flex justify-between items-center">
                ...
                <Navbar.Brand href="/missions" className={styles.navbarBrand}>
                    ...
                    <span className={styles.text}>Retos</span>
                </Navbar.Brand>
                <Navbar.Brand href="/maps" className={styles.navbarBrand}>
                    <svg className={styles.icon} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="m21 21-3.5-3.5M17 10a7 7 0 1 1-14 0 7 7 0 0 1 14 0Z" />
                    </svg>
                    <span className={styles.text}>Descubre</span>
                </Navbar.Brand>
                <Navbar.Brand href="/settings" className={styles.navbarBrand}>
                    <svg className={styles.icon} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className={styles.text}>Ajustes</span>
                </Navbar.Brand>
            </div>
        </Navbar>
