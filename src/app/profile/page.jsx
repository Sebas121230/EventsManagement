    ...
    return (
        <div className="flex flex-col items-center text-lg m-5 p-4 rounded-lg shadow mt-5 bg-[var(--secondary-background)] cursor-pointer">
            ...
            <div className="flex items-start p-4 mt-3 bg-gray-100 rounded-lg shadow w-full">
                ...
                <div>
                    <p><strong>Nombre: Juan Rodriguez</strong></p>
                    <p><strong>Email: jsrodriguezriveros@ucundinamarca.edu.co</strong></p>
...
<div className="flex items-start p-4 mt-3 bg-gray-100 rounded-lg shadow w-full">
                ...
                <div>
                    <p><strong>Nombre: Andres Bustos</strong></p>
                    <p><strong>Email: afbustos@ucundinamarca.edu.co</strong></p>
                    <p><strong>Edad: 26</strong></p>
                </div>
            </div>
